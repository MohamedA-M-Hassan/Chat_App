...
public class BooGyMainChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boogy_main_chat);
    ...
    private void sendMessage()
    {
        ...
        if(!input.equals(""))
        {
            ...
            mDatabaseReference.child("mesgs").push().setValue(chat);
            mInputText.setText("");
